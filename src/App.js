...
function App() {
  ...
  return (
    <div className="App flex flex-col w-full max-w-[420px] mx-auto md:border-x-8 md:border-y-[16px] border-black rounded-xl ">
                ...
                {showDisclaimer && (
                  <div className="disclaimer-popup">
                    <div className="disclaimer-popup-content">
                      ...
                      <ul>
                        <li>
                          <strong>Today:</strong> Clients with appointments
                          today.
                        </li>
                        <li>
